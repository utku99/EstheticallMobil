        ...
        <View className={`h-fit border border-customLightGray rounded-xl bg-white `} style={{ width: SIZES.width * 0.95 }}>
            ...
            <View className='flex-row  items-center p-[10px] space-x-2'>
                ...
                <View>
                    ...
                    <Text numberOfLines={1} className='text-customGray font-poppins text-xs '>{item?.address}</Text>
                </View>
            ...
            <View className='p-[10px]'>
                <View className='flex-row items-center space-x-2'>
                    ...
                    <Text numberOfLines={2} className='text-customGray font-poppins text-xs '>{item?.address}</Text>
                </View>
                <View className='flex-row items-center space-x-2'>
                    <PhoneIcon />
                    <Text className='text-customGray font-poppins text-xs '>{item?.phoneNumber}</Text>
                </View>
            </View>

            <CustomButtons type='iconsolid' label='Soru Sor' icon='question' style={{ width: 130, alignSelf: "center", marginBottom: 20 }} onPress={() => navigation.navigate("firmcommunicationquestion", { companyId: item.companyId, companyOfficeId: item.officeId })} />
