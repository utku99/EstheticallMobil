    ...
    <View
      ...
      <View className="flex-1 space-y-1">
        <Text className="text-customGray font-poppinsRegular text-xs">
          I had a smile with 24 veneers. Four days later Dr Ebru prepared my
          teeth and she put the veneers on. Now it looks amazing, I have a
          beautiful smile to go with my new look.
        </Text>
