                ...
                {selectedCompany &&
                    <View className='rounded-lg bg-white border border-customLightGray w-[85%] self-center my-8 p-2 space-y-3'>
                        <View className='flex-row items-center space-x-3'>
                            ...
                            <View >
                                <Text className='text-customGray font-poppins text-xs font-bold'>{selectedCompany?.name}</Text>
                                <Text className='text-customGray font-poppins text-xs'>{selectedCompany?.address}</Text>
                            </View>
                        </View>
                        <View className='flex-row items-center space-x-3 text'>
                            <FirmInfoLocationIcon />
                            <Text className='text-customGray font-poppins text-xs shrink' numberOfLines={2}>{selectedCompany?.address}</Text>
                        </View>
                        <View className='flex-row items-center space-x-3 text'>
                            <PhoneIcon />
                            <Text className='text-customGray font-poppins text-xs' numberOfLines={1}>{selectedCompany?.phoneNumber}</Text>
                        </View>
