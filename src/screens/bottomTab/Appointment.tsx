    ...
    return (
        <UserWrapper>
            ...
            <View className=' h-full w-full' style={{ width: SIZES.width * 0.95 }}>
                ...
                <Text className='font-medium text-customGray text-base font-poppins mb-3'>Randevu Al</Text>
                ...
                <CustomInputs type='dropdown' dropdownData={[]} placeholder='İlçe' style={{ width: "75%", height: 32 }} />
                ...
                <CustomInputs type='dropdown' dropdownData={[]} placeholder='Doktor Seç' style={{ width: "75%", height: 32 }} />
